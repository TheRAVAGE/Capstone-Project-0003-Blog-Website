...
//create dummy post
form [0] = new formDetails ('68433', 'The Benefits of Remote Work and How to Make It Work for You', '2024-8-17 : 0:33:50', 'ChatGPT', 'Remote work has evolved from a rare perk to a common work arrangement, especially accelerated by the COVID-19 pandemic. Its benefits are numerous and varied, making it an attractive option for both employees and employers.\r\n' +
  '\r\n' +
...
form [1] = new formDetails ('100807', 'Embracing Minimalism: How Simplifying Your Life Can Lead to Greater Fulfillment', '2024-8-17 : 4:58:43', 'Akhil M Mathew', 'In a world that often glorifies excess, minimalism presents a refreshing alternative. This lifestyle philosophy focuses on simplifying life by reducing physical and mental clutter, ultimately leading to greater fulfillment and well-being. Embracing minimalism can transform various aspects of your life, making room for what truly matters.\r\n' +
    '\r\n' +
...
app.post("/submit", (req, res) => {
  form [i] = new formDetails (req.body.ID, req.body.titleName, req.body.dateOfCreation, req.body.authorName, req.body.textContent);
  i++;
  res.redirect("/");
});
